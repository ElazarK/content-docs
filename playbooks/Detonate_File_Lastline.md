...
| Interval | The polling frequency. How often the polling command should run (minutes). | 1 |  | Optional |
...
![Detonate_File_Lastline](https://github.com/ElazarK/content-docs/blob/master/images/playbooks/Detonate_File_Lastline.png)
