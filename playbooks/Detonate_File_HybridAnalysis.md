...
| --- | --- | --- |
| File.SHA256 | The SHA256 file hash of the file. | date |
| File.SHA1 | The SHA1 file hash of the file. | unknown |
...
| HybridAnalysis.Submit.SHA256 | The submission SHA256 file hash. | unknown |
...
![Detonate_File_HybridAnalysis](https://github.com/ElazarK/content-docs/blob/master/images/playbooks/Detonate_File_HybridAnalysis.png)
