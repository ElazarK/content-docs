...
| NexposeSeverity | The Nexpose vulnerability severity score \(Moderate, Severe, Critical\). | Asset.Vulnerability.Severity | Nexpose | Optional |

## Playbook Outputs
---
There are no outputs for this playbook.

![Calculate_Severity_Generic](https://github.com/ElazarK/content-docs/blob/master/images/playbooks/Calculate_Severity_Generic.png)
